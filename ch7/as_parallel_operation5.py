# this example shows the use of a for loop to show the results
...
async def main():
    ...
    # the results shown in the order they are completed
    for task in asyncio.as_completed([as_cube(2), as_square(3)]):
        result = await task
